    ...
    <section className="min-h-[80vh] flex items-center bg-cream py-10 px-4">
      <div className="max-w-md w-full mx-auto">
        <div className="bg-paper rounded-3xl border border-line p-8 md:p-10 lift">
          ...
          <div className="caps-sm text-green-deep text-center mb-2">Welkom terug</div>
          <h1 className="display text-3xl md:text-4xl text-center mb-7 tracking-tight">Inloggen</h1>
          ...
          <div className="mt-6 caps-xs text-center text-ink-mute">
            Nog geen account?{" "}
            <Link href="/register" className="text-green-deep font-bold underline-offset-2 hover:underline">
              Maak er een aan
            </Link>
          </div>
        </div>
        ...
        <div className="mt-6 text-center caps-xs text-ink-mute">
          🔒 Demo: gebruik elk e-mail + wachtwoord ≥ 4 tekens
        </div>
      </div>
    </section>
  );
